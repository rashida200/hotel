    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <nav>
                ...
                <!-- Liens pour filtrer les réservations par état -->
                <a href="list.php"><i class="fas fa-list-alt"></i> All reservations</a>
                <a href="planned.php?etat=En cours"><i class="fas fa-list-alt"></i> Réservations planned</a>
        ...
        <div class="main-content">
            ...
            <div class="search-container">
                <form method="get" action="">
                    <input type="date" name="date_arrivee" value="<?= htmlspecialchars($date_arrivee) ?>" placeholder="Date d'arrivée">
                    <input type="date" name="date_depart" value="<?= htmlspecialchars($date_depart) ?>" placeholder="Date de départ">
                    <button type="submit" class="btn btn-primary">Rechercher</button>
                </form>
            </div>
            <div class="table-container">
                <h2>Liste des Réservations <?= !empty($etat_reservation) ? '(' . htmlspecialchars($etat_reservation) . ')' : '' ?></h2>
